...
async function generateOverviewFromDescription(context: CommandContext, description: string): Promise<string> {
  ...
  The overview should be a single sentence that captures the essence of the change. ALWAYS OBEY ./AGENTS.md, ./openspec/project.md, and ./openspec/AGENTS.md. DO NOT USE TOOLS.`;
...
async function generateMotivationFromDescription(context: CommandContext, description: string): Promise<string> {
  ...
  Explain why this change is needed and what problem it solves. ALWAYS OBEY ./AGENTS.md, ./openspec/project.md, and ./openspec/AGENTS.md. DO NOT USE TOOLS.`;
...
async function generateImplementationPlanFromDescription(context: CommandContext, description: string): Promise<string> {
  ...
  Detail the steps required to implement this change. ALWAYS OBEY ./AGENTS.md, ./openspec/project.md, and ./openspec/AGENTS.md. DO NOT USE TOOLS.`;
...
async function generateImpactAssessmentFromDescription(context: CommandContext, description: string): Promise<string> {
  ...
  Describe the potential impact of this change on the system. ALWAYS OBEY ./AGENTS.md, ./openspec/project.md, and ./openspec/AGENTS.md. DO NOT USE TOOLS.`;
...
async function generateTasksFromDescription(context: CommandContext, description: string): Promise<string> {
  ...
  Provide 3-5 specific tasks in a markdown checklist format. ALWAYS OBEY ./AGENTS.md, ./openspec/project.md, and ./openspec/AGENTS.md. DO NOT USE TOOLS.`;
...
async function generateApproachFromDescription(context: CommandContext, description: string): Promise<string> {
  ...
  Describe the technical approach for implementing this change. ALWAYS OBEY ./AGENTS.md, ./openspec/project.md, and ./openspec/AGENTS.md. DO NOT USE TOOLS.`;
...
async function generateArchitectureFromDescription(context: CommandContext, description: string): Promise<string> {
  ...
  Outline any architectural considerations or changes. ALWAYS OBEY ./AGENTS.md, ./openspec/project.md, and ./openspec/AGENTS.md. DO NOT USE TOOLS.`;
...
async function generateDependenciesFromDescription(context: CommandContext, description: string): Promise<string> {
  ...
  List any dependencies or prerequisites for this change. ALWAYS OBEY ./AGENTS.md, ./openspec/project.md, and ./openspec/AGENTS.md. DO NOT USE TOOLS.`;
