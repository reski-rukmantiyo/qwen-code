...
/**
 * Template for the OpenSpec instructions AGENTS.md that provides comprehensive
 * instructions for AI assistants working with OpenSpec.
 */
export const OPENSPEC_AGENTS_MD_TEMPLATE = `# OpenSpec Instructions for AI Assistants
