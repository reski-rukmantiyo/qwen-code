...
- **Subagent Delegation:** When doing file search or any task, you MUST use the '${ToolNames.TASK}' tool with specialized agents. All tasks must be delegated to appropriate subagents - do not attempt to perform tasks directly.
